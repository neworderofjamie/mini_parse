...
public:
    ...
    const Type::Base *assign(const Token &name, const Type::Base *type, ErrorHandler &errorHandler);
    const Type::Base *incDec(const Token &name, ErrorHandler &errorHandler);
